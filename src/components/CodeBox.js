...
export default class CodeBox extends Component {
  ...
  getIconCode() {
    return this.state.showCode ? <img alt="expand code" src="https://gw.alipayobjects.com/zos/rmsportal/OpROPHYqWmrMDBFMZtKF.svg" className="code-expand-icon-show" /> : <img alt="expand code" src="https://gw.alipayobjects.com/zos/rmsportal/wSAkBuJFbdxsosKKpqyq.svg" className="code-expand-icon-hide" />
  }

  render() {
    const { codeBoxResult, codeBoxMeta, codeBoxCode, codeBoxMetaTitle } = this.props;
      ...
      <SectionWrapper showCode={showCode}>
        ...
        <section className="highlight-wrapper">
          <div className="highlight">
            <SyntaxHighlighter language='javascript' style={docco}>{codeBoxCode}
            </SyntaxHighlighter>
          </div>
        </section>
      </SectionWrapper>
